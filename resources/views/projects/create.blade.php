...
<div style="width: 40%; margin: 50px auto; padding: 30px; border: 1px solid #ddd; border-radius: 8px;">
    ...
    <h2 style="text-align: center; margin-bottom: 25px;">Create Project</h2>
    ...
    <form method="POST" action="{{ route('projects.store') }}">
        ...
        <div style="text-align: center;">
            <button type="submit" 
                    style="padding: 8px 20px; background-color: #4CAF50; color: white; border: none; border-radius: 4px;">
                Save
            </button>
        </div>
    </form>
